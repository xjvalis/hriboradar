  ...
  return (
    <View style={styles.padded}>
      <View style={styles.supportRow}>
        <Bug size={ts(16)} strokeWidth={1.8} color={palette.inkFaint} />
        ...
        <Pressable onPress={copySupportEmail} hitSlop={8} style={styles.copyBtn}>
          {emailCopied ? (
            <Check size={ts(15)} strokeWidth={2} color={palette.success} />
          ) : (
            <Copy size={ts(15)} strokeWidth={1.8} color={palette.inkFaint} />
          )}
        </Pressable>
      </View>
    </View>
